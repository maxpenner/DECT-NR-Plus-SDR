...
class channel_awgn_t final : public channel_t {
    public:
        explicit channel_awgn_t(const uint32_t id_0_,
                                const uint32_t id_1_,
                                const uint32_t samp_rate_,
                                const uint32_t spp_size_);
        ~channel_awgn_t() = default;

        channel_awgn_t() = delete;
        channel_awgn_t(const channel_awgn_t&) = delete;
        channel_awgn_t& operator=(const channel_awgn_t&) = delete;
        channel_awgn_t(channel_awgn_t&&) = delete;
        channel_awgn_t& operator=(channel_awgn_t&&) = delete;
