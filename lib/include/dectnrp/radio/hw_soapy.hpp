...
class hw_soapy_t final : public hw_t {
    public:
        explicit hw_soapy_t(const hw_config_t& hw_config_);
        ~hw_soapy_t() = default;

        hw_soapy_t() = delete;
        hw_soapy_t(const hw_soapy_t&) = delete;
        hw_soapy_t& operator=(const hw_soapy_t&) = delete;
        hw_soapy_t(hw_soapy_t&&) = delete;
        hw_soapy_t& operator=(hw_soapy_t&&) = delete;
