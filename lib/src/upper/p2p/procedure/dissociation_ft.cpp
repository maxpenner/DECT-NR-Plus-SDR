...
phy::machigh_phy_t dissociation_ft_t::work_pdc(
    [[maybe_unused]] const phy::phy_machigh_t& phy_machigh) {
    return phy::machigh_phy_t();
}

phy::machigh_phy_t dissociation_ft_t::work_pdc_error(
    [[maybe_unused]] const phy::phy_machigh_t& phy_machigh) {
    return phy::machigh_phy_t();
}
...
phy::machigh_phy_tx_t dissociation_ft_t::work_chscan([[maybe_unused]] const phy::chscan_t& chscan) {
