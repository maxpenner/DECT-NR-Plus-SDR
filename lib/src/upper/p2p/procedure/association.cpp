...
phy::machigh_phy_t association_t::work_pdc([[maybe_unused]] const phy::phy_machigh_t& phy_machigh) {
    return phy::machigh_phy_t();
}

phy::machigh_phy_t association_t::work_pdc_error(
...
phy::machigh_phy_tx_t association_t::work_channel([[maybe_unused]] const phy::chscan_t& chscan) {
